          ...
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "5rem" }}>
              ...
              <p style={{ color: "var(--rm-muted)", maxWidth: 550, margin: "1rem auto 0", fontSize: "0.95rem", fontWeight: 300, lineHeight: 1.8 }}>
                Chaque projet est unique. Nous adaptons notre approche pour créer l'outil digital parfait pour votre activité.
              </p>
            </div>
          </Reveal>
        ...
        <Container>
          <Reveal>
            ...
            >
              ...
              >
                Découvrez nos <em style={{ fontStyle: "italic", color: "var(--rm-gold)" }}>packs</em> et tarifs
              </h3>
              <p style={{ color: "var(--rm-muted)", maxWidth: 520, margin: "0 auto 2rem", fontSize: "0.92rem", fontWeight: 300, lineHeight: 1.8 }}>
                Du site vitrine à la solution premium complète, retrouvez toutes nos formules sur la page Tarifs et obtenez votre devis personnalisé.
              </p>
