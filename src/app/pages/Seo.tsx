  ...
  return (
    <>
      <PageHero
        ...
        title={<>Soyez visible sur <Gold>Google</Gold> durablement</>}
        description="Une stratégie SEO complète pour positionner votre entreprise en tête des résultats de recherche et attirer un trafic qualifié en continu."
      />
        ...
        <Container>
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: "5rem" }}>
              <SectionEyebrow center>Les 4 piliers du SEO</SectionEyebrow>
              <SerifTitle center>Une approche <Gold>complète</Gold> et structurée</SerifTitle>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div style={{ display: "flex", gap: "5rem", flexWrap: "wrap", alignItems: "flex-start" }}>
              <div style={{ flex: 1, minWidth: 280 }}>
                <SectionEyebrow>Pourquoi le SEO ?</SectionEyebrow>
                <SerifTitle>Le trafic <Gold>organique</Gold> est le plus rentable</SerifTitle>
              </div>
